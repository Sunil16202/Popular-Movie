...
import com.example.popularmovies.network.RetrofitClient;
...
public class MainActivity extends AppCompatActivity {
    ...
    private Call<MovieUpdate> movieResultCall;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mNoInternetIv = findViewById(R.id.no_internet);
        mNoInternetTv = findViewById(R.id.internet_tv);
    ...
    private void loadPage(final int page) {
        ...
        movieResultCall.enqueue(new Callback<MovieUpdate>() {
            @Override
            public void onResponse(Call<MovieUpdate> call, Response<MovieUpdate> response) {
            ...
            @Override
            public void onFailure(Call<MovieUpdate> call, Throwable t) {
